      ...
      <div class="panel panel-primary">
        ...
        <form name=alipayment action=codepay.php method=post>
			...
			<div class="input-group">
              ...
              <input size="30" name="price" value="<?php echo $jbdayx; ?>" class="form-control" placeholder="付款金额" disabled/>
...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
  <div class="btn-group" role="group">
    <button type="radio" name="type" value="1" class="btn btn-primary">支付宝支付</button>
  </div>
  <div class="btn-group" role="group">
    <button type="radio" name="type" value="2" class="btn btn-success">QQ支付</button>
  </div>
  <div class="btn-group" role="group">
    <button type="radio" name="type" value="3" class="btn btn-info">微信支付</button>
  </div>
</div>
</center> </div>
          </form>
