 ...
 *
 * @icon fa fa-circle-o
 * @remark 可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。已上线插件商店 ，你可以发布你的免费或付费插件</a>
 */
class Addon extends Backend
{

    protected $model = null;
    protected $noNeedRight = ['start', 'pause', 'change', 'detail', 'cxselect', 'searchlist' ,'index','config'];
    ...
    public function downloaded()
    {
        ...
        if (!is_array($onlineaddons)) {
            $onlineaddons = [];
            $result = Http::sendRequest(config('fastadmin.api_url') . '/index.php/news/Index/addon');
            if ($result['ret']) {
