<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/zzz.sfpfg.cn/public/../application/admin/view/dashboard/index.html";i:1558774096;s:68:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/layout/default.html";i:1558774088;s:65:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/meta.html";i:1558774088;s:67:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/script.html";i:1558774088;}*/ ?>
<!DOCTYPE html>
                                ...
                                <div class="row row-sm stats-container">
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> 今日提现<!-- <?php echo __('Seven dau'); ?> --> </div>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success" style="width: 25%"></div>
                                        </div>
                        ...
                        <div class="panel bg-blue">
                            <div class="panel-body">
                                ...
                                <div class="panel-content">
                                    <h1 class="no-margins"><?php echo $totaltoss; ?></h1>
                                    <div class="stat-percent font-bold text-gray"><i class="fa fa-commenting"></i> <?php echo $totaltoss; ?></div>
                        ...
                        <div class="panel bg-aqua-gradient">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins"><?php echo $allss; ?></h1>
                                    <div class="stat-percent font-bold text-gray"><i class="fa fa-modx"></i> <?php echo $allss; ?></div>
                        ...
                        <div class="panel bg-purple-gradient">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $allcz; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-commenting"></i> <small><?php echo __('Comment count'); ?></small></div>
                                        </div> -->
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $allyj; ?></h1>
                                            <div class="font-bold text-navy"><i class="fa fa-heart"></i> <small>当日佣金统计</small></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box box-danger">
                            <div class="box-header">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="https://www.jingxiutequn.com" target="_blank" class="btn btn-box-tool"><?php echo __('More'); ?></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="box box-success">
                            <div class="box-header">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="http://www.jingxiutequn.com" class="btn btn-box-tool"><?php echo __('More'); ?></a>
                                </div>
                            </div>
