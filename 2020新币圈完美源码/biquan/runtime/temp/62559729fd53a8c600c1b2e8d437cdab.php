<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/www/wwwroot/zzz.sfpfg.cn/public/../application/admin/view/general/config/index.html";i:1558774406;s:68:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/layout/default.html";i:1558774088;s:65:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/meta.html";i:1558774088;s:67:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/script.html";i:1558774088;}*/ ?>
<!DOCTYPE html>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-sm-8 col-xs-12">
                                                ...
                                                <div class="form-inline">
                                                    <input id="c-<?php echo $item['name']; ?>" class="form-control" size="60" name="row[<?php echo $item['name']; ?>]" type="text" value="<?php echo $item['value']; ?>" data-tip="<?php echo $item['tip']; ?>">
