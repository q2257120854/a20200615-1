<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/zzz.sfpfg.cn/public/../application/admin/view/user/user/edit.html";i:1558774412;s:68:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/layout/default.html";i:1558774088;s:65:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/meta.html";i:1558774088;s:67:"/www/wwwroot/zzz.sfpfg.cn/application/admin/view/common/script.html";i:1558774088;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-groupid" class="control-label col-xs-12 col-sm-2"><?php echo __('Group'); ?>:</label>
    ...
    <div class="form-group">
        <label for="c-point" class="control-label col-xs-12 col-sm-2"><?php echo __('point'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-point" data-rule="required" class="form-control" name="row[point]" type="number" value="<?php echo $row['point']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-amount" class="control-label col-xs-12 col-sm-2"><?php echo __('amount'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-amount" data-rule="required" class="form-control" name="row[amount]" type="number" value="<?php echo $row['amount']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-expense" class="control-label col-xs-12 col-sm-2"><?php echo __('expense'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-expense" data-rule="required" class="form-control" name="row[expense]" type="number" value="<?php echo $row['expense']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-email" class="control-label col-xs-12 col-sm-2"><?php echo __('fatherid'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-fatherid" data-rule="" class="form-control" name="row[fatherid]" type="text" value="<?php echo $row['fatherid']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-openid" class="control-label col-xs-12 col-sm-2"><?php echo __('openid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-openid" data-rule="" class="form-control" name="row[openid]" type="text" value="<?php echo $row['openid']; ?>">
        </div>
    </div>
