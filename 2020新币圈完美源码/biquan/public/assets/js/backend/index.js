define(['jquery', 'bootstrap', 'backend', 'addtabs', 'adminlte', 'form'], function ($, undefined, Backend, undefined, AdminLTE, Form) {
    var Controller = {
        index: function () {
            ...
            //读取FastAdmin的更新信息
            $.ajax({
                url: Config.fastadmin.api_url + '/index.php/news/index',
                type: 'post',
                dataType: 'jsonp',
            ...
            if (localStorage.getItem("fastep") == "installed") {
                $.ajax({
                    url: Config.fastadmin.api_url + '/index.php/news/Index/addon/recommend/1',
                    type: 'post',
                    dataType: 'jsonp',
                    success: function (ret) {
            ...
            var checkupdate = function (ignoreversion, tips) {
                $.ajax({
                    url: Config.fastadmin.api_url + '/index.php/news/Index/version/check/1',
                    type: 'post',
