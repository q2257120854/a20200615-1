...
class Auth
{
     ...
     *              array('uid'=>'用户id','groupid'=>'用户组id','name'=>'用户组名称','rules'=>'用户组拥有的规则id,多个,号隔开'),
     *              ...)
     */
    public function getGroups($uid)
    {
        ...
        $user_groups = Db::name($this->config['auth_group_access'])
                ->alias('aga')
                ->join('__' . strtoupper($this->config['auth_group']) . '__ ag', 'aga.groupid = ag.id', 'LEFT')
                ->field('aga.uid,aga.groupid,ag.id,ag.pid,ag.name,ag.rules')
