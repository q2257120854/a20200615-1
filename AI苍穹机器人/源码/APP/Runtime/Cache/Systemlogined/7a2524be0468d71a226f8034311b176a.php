    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form class="form-horizontal" name="addProductHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Task/sendtaskpost');?>" method="post">
                    <div class="control-group">
                        <label class="control-label" for="jinbi"> 奖励金</label>

                        <div class="controls">
                            <input type="text" value="" name="jinbi" id="jinbi" placeholder="" /> <font color="red">*  单次转发奖励金</font>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="taskcount"> 发布次数</label>

                        <div class="controls">
                            <input type="text" value="" name="taskcount" id="taskcount" placeholder="" /> <font color="red">*  累计发送次数</font>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="content"> 广告内容</label>
