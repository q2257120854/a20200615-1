				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						   <div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Dai/pinAdd');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>生成激活码</a>
						    </div>
					   </div>
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
											...
											<td>
											<a onclick="if(confirm('删除后不可恢復！您确定要删除此激活码吗?')==false)return false;" href="<?php echo U(GROUP_NAME .'/Dai/deletePin',array('id'=>$v['id']));?>"><font color=red>删除</font></a>       </td>
