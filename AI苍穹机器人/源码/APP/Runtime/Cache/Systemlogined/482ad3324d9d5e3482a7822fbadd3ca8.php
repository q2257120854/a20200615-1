...
<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Member')][strtoupper('check')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li url="Membercheck">
	...
	<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Member')][strtoupper('shu_list')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li url="Membercheck">
		...
		<li>
			...
			<ul class="submenu">
				<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Member')][strtoupper('pin_loglist')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li>
				...
				<?php if((isset($acc[strtoupper(GROUP_NAME)][strtoupper('Member')][strtoupper('pin_loglist')])) or (!empty($_SESSION[C('ADMIN_AUTH_KEY')]))): ?><li>
					...
					<li>
						<a href="<?php echo U(GROUP_NAME.'/Member/pin_loglist');?>">
							<i class="icon-double-angle-right"></i>
							激活码日志
						</a>
					</li>
    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form id="table-searchbar" method="POST" action="<?php echo U(GROUP_NAME.'/member/pin_loglist');?>" class="form-inline well well-small">
                    <div class="row-fluid">&nbsp;&nbsp;转出账号
                ...
                <div class="row-fluid">
                    <table id="table_report" class="table table-striped table-bordered table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><a target="_blank" href="<?php echo U('Member/inMember',array('u'=>$v['jsmember']));?>"><?php echo ($v["jsmember"]); ?></a></td>
