    ...
    <div id="main-content" class="clearfix">
        ...
        <div id="page-content" class="clearfix">
            ...
            <div class="row-fluid">
                ...
                <form name="editAnnounceType" class="form-horizontal"  action="<?php echo U(GROUP_NAME.'/Dai/chekusersHandle');?>" method="post">
                    <input type="hidden" name="mobile" value="<?php echo ($member['username']); ?>">
                    <input type="hidden" name="jinbidy" value="<?php echo ($member["dyjinbi"]); ?>}">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="dyjinbi">
                            抵押金额：</label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($member["dyjinbi"]); ?>" name="dyjinbi" id="dyjinbi" disabled />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="jinbi">
                            贷款金额：</label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($member["jinbi"]); ?>" name="jinbi" id="jinbi" disabled />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="sktype">
                            银行名称：</label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($member["sktype"]); ?>" name="sktype" id="sktype" disabled />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="sknumber">
                            银行卡号：</label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($member["sknumber"]); ?>" name="sknumber" id="sknumber" disabled />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="spjinbi">
                            审批金额：</label>
                        <div class="controls">
                            <input type="text" value="<?php echo ($member["spjinbi"]); ?>" name="spjinbi" id="spjinbi"/>
                        </div>
                    </div>
