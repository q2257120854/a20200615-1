					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" class="form-inline well well-small">
							<div class="row-fluid">&nbsp;&nbsp;用户编号 
				                <input type="text" class="input-small" name="li_logaccount" value="<?php echo $_POST['li_logaccount'];?>">    
		                        &nbsp;&nbsp;开始日期
		                        <input type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="input-small" value="<?php echo $_POST['be_logtime'];?>" name="be_logtime">
						        &nbsp;&nbsp;截止日期
						...
						<div class="row-fluid">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										<td colspan="7" style="text-align:center;"><div class="page"><?php echo ($page); ?></div></td>
									</tr>
								</tbody>
							</table>
						</div>
