                ...
                <div class="row-fluid">
                    <table id="table_report" class="table table-striped table-bordered table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                ...
                                <td><?php echo ($v["sktype"]); ?></td>
                                <td><?php echo ($v["sknumber"]); ?></td>
                                <td><?php echo (date('Y-m-d H:i:s',$v["tjdate"])); ?></td>
                                <td><?php echo (date('Y-m-d H:i:s',$v["shdate"])); ?></td>
                                <td>
                                    <?php if($v["status"] == 0): ?><font color="#00008b">未审核</font><?php endif; ?>
                                    <?php if($v["status"] == 1): ?><font color="red">已审核</font><?php endif; ?>
                                    <?php if($v["status"] == 2): ?><font color="red">已拒绝</font><?php endif; ?>
                                </td>
                                <td><a href="<?php echo U(GROUP_NAME .'/Dai/chekusers',array('id'=>$v['id']));?>">额度修改</a></td>
