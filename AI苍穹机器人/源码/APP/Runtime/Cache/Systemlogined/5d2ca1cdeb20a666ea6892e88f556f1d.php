	...
	<!--边栏-->
			...
			<div id="main-content" class="clearfix">
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
							<form name="editAnnounceType" class="form-horizontal"  action="<?php echo U(GROUP_NAME.'/Task/completeuserHandle');?>" method="post">
								<div class="control-group">
									<label class="control-label" for="username"> 会员编号</label>

									<div class="controls">
										<input type="text" name="username" <?php if($_GET['id']!= 1): ?>readonly="readonly"<?php endif; ?> value="<?php echo ($complete["username"]); ?>" id="username"/>
										<a href="<?php echo U(GROUP_NAME.'/Task/completeuser',array('id'=>$next_id));?>" style="cursor:pointer; padding:6px 15px; color:#ffffff; background:#06F; border-radius:4px;">审核下一个</a>
									</div>
								</div>
								...
								<div class="control-group">
									...
									姓名：</label>
									<div class="controls">
										<input type="text" value="<?php echo ($complete["truename"]); ?>" name="truename" id="truename" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="jinbi">
										奖励金：</label>
									<div class="controls">
										<input type="text" value="<?php echo ($complete["jinbi"]); ?>" name="jinbi" id="jinbi" /><font color="red">* 审核通过，即时到账！</font>
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="pic">完成截图</label>
									<div class="controls">
										<img src="<?php echo ($complete['pic']); ?>" width="200" />
									</div>
					  ...
					  <input type="hidden" name="id" value="<?php echo ($complete["id"]); ?>" />
