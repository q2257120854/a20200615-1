...
<div class="mui-content padding4 bgpink">
    ...
    <div   class="mui-slider kechengsbox">
        <div   class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted kcsidertop">
            ...
            <div class="mui-control-item mui-active"><a href="<?php echo U('Index/index/team1');?>">二代</a></div>
            <div class="mui-control-item mui-active mui-active"><a href="<?php echo U('Index/index/team2');?>">三代</a></div>
        </div>
