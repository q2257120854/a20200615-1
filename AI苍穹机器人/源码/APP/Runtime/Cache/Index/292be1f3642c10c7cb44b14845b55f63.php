...
<div style=" width:100%; margin:10px auto; text-align:center;">
    ...
    <a href="<?php echo U('Index/Dai/jihuomazz');?>" class='aall foncus' style="margin-right:10px;">激活码转出</a>

    <a href="<?php echo U('Index/Dai/jihuoma');?>" class='aall'>我的激活码</a>

</div>

<!--列表开始-->
<form action="<?php echo U('Index/Dai/jihuomazzs');?>" method="POST" id="form1" style="font-size:14px; padding-bottom:26px;">
...
<script>
    $("input[name='submit']").click(function(){
        ...
        $.showLoading("正在提交");
        $.ajax({
            url:"<?php echo U('Index/Dai/jihuomazzs');?>",
            type:"post",
            ...
            success:function(data){
                if(data.status==1){
                    $.alert(data.info,function(){
                        window.location = "<?php echo U('Index/Dai/jihuomazz');?>";
                    })
                }else{
                    $.alert(data.info);
                    btn.attr("clicked","0");
