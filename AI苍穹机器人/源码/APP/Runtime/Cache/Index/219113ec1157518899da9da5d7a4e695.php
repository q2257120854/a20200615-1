			...
			<div data-page="system-service" class="page navbar-fixed" isinited="true">
				<div class="navbar theme-white">
					<div class="navbar-inner">
						...
						<div class="center" data-i18n="member.myinfo" style="left: -24px;">联系客服</div>
						<div class="right"></div>
					</div>
				</div>
				...
				<div class="page-content">
					<div class="content-block">
						<div id="serviceList" class="row">
							...
							<div class="col-100 h-jgg2">
								<div class="row service-bar">
									<div class="col-20"><img class="avatar" src="/Public/dianyun/img/9e28eafeb7d8e8722be6b7e4a7f26373.png"></div>
									<div class="col-50">
										<label>QQ客服一001</label>
										<span id="copy-num"><?php echo ($kefu1); ?></span>
									</div>
									<div class="col-30" style="padding-top:10px;">
										<a href="javascript:void(0);" onclick="jsCopy()" class="external button-clipboard" data-clipboard-target="#lblNo0">
											<img src="/Public/dianyun/img/button-see.png" style="width:70px;height: auto;">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-100 h-jgg2">
								<div class="row service-bar">
									<div class="col-20"><img class="avatar" src="/Public/dianyun/img/ba43e3fea7a7ae6dbe9b10fd3853232e.png"></div>
									<div class="col-50">
										<label>QQ客服一002</label>
										<span id="copy-numa"><?php echo ($kefu2); ?></span>
									</div>
									<div class="col-30" style="padding-top:10px;">
							...
							</div><div class="col-100 h-jgg2">
							<div class="row service-bar">
								<div class="col-20"><img class="avatar" src="/Public/dianyun/img/fc888b02370e2c23b06ff90e177c5156.png"></div>
								<div class="col-50">
									<label>QQ客服一003</label>
									<span id="copy-numb"><?php echo ($kefu3); ?></span>                        </div>
								<div class="col-30" style="padding-top:10px;">
									<a href="javascript:void(0);" onclick="jsCopyb()" class="external button-clipboard" data-clipboard-target="#lblNo2">
									<img src="/Public/dianyun/img/button-see.png" style="width:70px;height: auto;">       </a></div>
							</div>
						</div>
						</div>
						...
						<div class="row hide">
							<div class="col-100 h-jgg2">
								<div class="row service-bar">
									...
									<div class="col-20"><a href="tel://" class="external">
						...
						<div class="row hide">
							<div class="col-100">
								<a href="tel://" class="external button button-large button-fill submitbtn">
