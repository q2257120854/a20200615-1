...
<div style=" width:100%; margin:10px auto; text-align:center;">
	...
	<a href="<?php echo U('Index/Financial/kChangeOutList');?>" class='aall foncus' style="margin-right:10px;">转出记录</a>
    
    <a href="<?php echo U('Index/Financial/kChangeInList');?>" class='aall'>转入记录</a>
	...
	<table style="width: 90%;margin-left: 5%;color: #333333;border-collapse:collapse;">
        <thead style="font-size: 14px; ">
            ...
            <tr style="height: 35px;line-height: 35px;">
				 <th  style="border-bottom:2px solid #ddd ">转出时间</th>
                 <th style="border-bottom:2px solid #ddd ">转出至账户</th>
                 <th style="border-bottom:2px solid #ddd ">转出数量</th>
                 <th style="border-bottom:2px solid #ddd ">手续费</th>
