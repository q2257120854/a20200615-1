...
<div style=" width:100%; margin:10px auto; text-align:center;">
    ...
    <a href="<?php echo U('Index/PersonalSet/jihuomazz');?>" class='aall' style="margin-right:10px;">激活码转出</a>

    <a href="<?php echo U('Index/PersonalSet/jihuoma');?>" class='aall foncus'>我的激活码</a>
