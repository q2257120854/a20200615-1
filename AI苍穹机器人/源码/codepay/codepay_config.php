 ...
 * 版本：4.53
 * 修改日期：2018/1/7
 *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
 * 说明： *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
 * 以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己网站的需要，按照技术文档编写,并非一定要使用该代码。
 * 该代码仅供学习和研究接口使用，只是提供一个参考。
 *
 * 注意：UTF-8编码不要在记事本下编辑 否则会出现一些奇葩的问题 正确方法应在开发工具打开编辑 *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
 */
 *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
...
/**订单支付页面显示方式
 * 3：自定义开发模式 (默认 复杂 需要一定开发能力  codepay.php修改收银台代码) *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
...
function isHTTPS()
{
    ...
    if ($_SERVER['HTTPS'] === 1) {  //Apache *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
        return TRUE;
 ...
 */
define('ROOT_PATH', dirname(__FILE__)); //这是程序目录常量 *此程序由苍穹网络科技工作室分享，三岁半乐网：https://www.sansuib.com
...
define('DB_USER', 'zz');  //数据库用户名
define('DB_PWD', 'hbjrGbpFDjCfaJty');//数据库密码
define('DB_NAME', 'zz');  //数据库名称
