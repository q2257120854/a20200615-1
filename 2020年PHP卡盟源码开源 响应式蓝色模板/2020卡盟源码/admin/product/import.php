...
$id=inject_check($id);
$total=mysql_num_rows(mysql_query("select * from `product` where id='$id' and sid=0 and pid=0 ",$conn1));
if ($total==0){
...
<a href="#art1" onClick="art.dialog.open('user/Product/view.php?id=<?=$row['id']?>&ooxx=1',{title:'<?=$row['modl']?>详细信息',width:600,height:400,lock:true, fixed:true});">查看</a></td>
</tr>
<tr>
