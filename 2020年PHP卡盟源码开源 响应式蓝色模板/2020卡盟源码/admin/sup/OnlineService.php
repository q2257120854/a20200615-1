...
<li class="hover"><a href="#">Sup订单投诉(<?=mysql_num_rows(mysql_query("select  sid from  Complaints_feedback  where audit='0' and sid<>0 ",$conn1));?>)</a></li>
</ul>
</div>
