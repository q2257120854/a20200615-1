...
<div class="Menubox" >
<ul>
<li class="hover"><a href="DHandleSave.php">平台订单 (<?=mysql_num_rows(mysql_query("select docking from  product_order  where docking!=0 and trading=0 ",$conn1));?>)</a></li>
