...
(function () {
    ...
    var mkBtn = function (txt, sign, autoClose, id) {
        ...
        var OkClass = "";
        if (curCfg.OkClass) {
            OkClass = curCfg.OkClass;
        }
        return {
            id: id,
            html: "<input type='button' id='" + id + "' onclick='Dialog.doHandler(\"" + sign + "\"," + autoClose + ")' style='cursor:pointer' class='btnStyle handler " + OkClass + "' value='" + txt + "' />"
        };
    };
    /*生成按钮组合的html*/
    ...
    (function () {
        ...
        var winVisible = function (visible) {
            ...
            var NoticeContentClass = "";
            if (curCfg.NoticeContentClass) {
                NoticeContentClass = curCfg.NoticeContentClass;
            }
            ...
            ym_body.className = "ym-body " + curCfg.icoCls + " " + NoticeContentClass; //图标类型
