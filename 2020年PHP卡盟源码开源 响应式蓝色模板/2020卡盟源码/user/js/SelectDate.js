var dlydate = function (startyear, startmonth, startday, starthour, startminute, endyear, endmonth, endday, endhour, endminute, a1, a2, a3, a4, a5, a6, h1) {
    this._startyear = dlydate.$(startyear); 
    this._startmonth = dlydate.$(startmonth);
    this._startday = dlydate.$(startday);
    this._starthour = dlydate.$(starthour);
    this._startminute = dlydate.$(startminute);
    this._endyear = dlydate.$(endyear);
    this._endmonth = dlydate.$(endmonth);
    this._endday = dlydate.$(endday);
    this._endhour = dlydate.$(endhour);
    this._endminute = dlydate.$(endminute);
    ...
    if (arguments.length == 17)
    {
        ...
        if (this._h1.value != "")
        {
            this.setClass(dlydate.$(this._h1.value));
        }
    }
