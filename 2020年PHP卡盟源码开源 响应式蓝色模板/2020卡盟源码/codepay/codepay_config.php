...
define('DB_USER', 'demo_juheshe_cn');  //数据库用户名
define('DB_PWD', 'nAfzdc7X3d');//数据库密码
define('DB_NAME', 'demo_juheshe_cn');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'members');  //充值用户所在数据库表名
define('DB_USERMONEY', 'kuan');  //充值用户所在表中的金额字段名
define('DB_USERNAME', 'number');  //充值用户名的字段名 根据用户名转换为id
