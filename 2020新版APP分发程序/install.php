...
print"	<div class=\"setup step1\">
	...
	<p>版权所有 (c) 2011-$year Jike-分发软件保留所有权利。Jike-分发交流QQ群：101033535</p>
...
show_msg('恭喜！Jike-分发 顺利安装完成！<br>为了保证数据安全，请手动删除{static/install}目录！<br><br>您的后台管理员帐号与前台会员帐号已经成功建立。接下来，您可以：<br><br><a href="index.php" target="_blank">进入网站首页</a><br>或 <a href="admin.php" target="_blank">进入管理后台</a> 以管理员身份对站点参数进行设置！Jike-分发交流QQ群：101033535',999);
}else {
